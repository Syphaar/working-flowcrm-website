...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium cursor-pointer transition-colors hover:bg-[#5D52E5] hover:text-white focus:bg-[#5D52E5] focus:text-white focus:outline-none disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed data-[state=open]:text-white data-[state=open]:bg-[#5D52E5]/50 data-[state=open]:hover:bg-[#5D52E5] data-[state=open]:focus:bg-[#5D52E5]",
);
